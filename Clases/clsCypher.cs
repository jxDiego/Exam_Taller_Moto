...
namespace Exam_Taller_Moto.Clases
{
    ...
    {
        //esta es la propiedad que se encarga de recibir la clave plana
        public string Password { get; set; }
        //esta es la propiedad que se encarga de devolver la clave cifrada
        public string PasswordCifrado { get; set; }
        //esta es la propiedad que se encarga de devolver el salt
